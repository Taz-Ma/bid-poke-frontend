...
const Cards = props => { 
    ...
    useEffect(()=>{
        fetch(`https://bid-pokemon-backend.onrender.com/item/${bid_id}`)
            .then(res => res.json())
            .then(data => {
        ...
        fetch(`https://bid-pokemon-backend.onrender.com/bid/highest/${bid_id}`)
            .then(res => res.json())
            .then(data => { 
    ...
    function handleNewBid(event){
        ...
        fetch('https://bid-pokemon-backend.onrender.com/bid/add', {
            method: 'POST',
            headers: {
